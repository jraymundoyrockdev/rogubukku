            ...
            <div class="inputs">
                ...
                <?php if ($message): ?>
                    ...
                    <div class="alert alert-danger alert-dismissible" role="alert">
                        ...
                        <strong><h4 style="margin-bottom:0px"><i class="fa fa-exclamation-triangle"></i>
                        </strong> <?= $message ?></h4>
                    </div>
                ...
                <div class="form-group">
                    <div class="signin-user-name-error <?= $has_error ?>">
                        <?= Form::input('signin_username', $signin_username,
                            ['placeholder' => 'Username', 'class' => 'login-input', 'id' => 'signin_username']); ?>
                    </div>
                </div>
                <div class="form-group">
                    <div class="signin-password-error <?= $has_error ?>">
                        <?= Form::password('signin_password', '',
                            ['placeholder' => 'Password', 'class' => 'login-input']); ?>
                    </div>
                </div>
                <?= Form::button('sign_in', 'Sign In', array(
                    'type' => 'submit',
                    'class' => 'btn btn-default wide fa medhidden redborder',
                    'id' => 'signin_button',
                    $disable_button
                )); ?>
            </div>
                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                <?= Form::open('login/signup',
                                    array('class' => 'search_form', 'id' => 'signup_form')); ?>
                                <div class="form-group">
                                    <div class="signup-full-name-error">
                                        <?= Form::input('full_name', '',
                                            ['placeholder' => 'Full Name', 'class' => 'login-input']); ?>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="signup-user-name-error">
                                        <?= Form::input('username', '',
                                            ['placeholder' => 'Username', 'class' => 'login-input']); ?>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="signup-password-confirm-error">
                                        <?= Form::password('password_confirm', '',
                                            ['placeholder' => 'Confirm Password', 'class' => 'login-input']); ?>
                                    </div>
                                </div>
                                <?= Form::button('sign_up', 'Sign Up', array(
                                    'type' => 'submit',
                                    'class' => 'btn btn-default wide fa medhidden redborder'
                                )); ?>
                                <?= Form::close(); ?>
...
<div class="modal fade" id="signUpSuccessfullModal" tabindex="-1" role="dialog" aria-labelledby="signUpSuccessfullModal"
     aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="alert alert-info alert-dismissible fade in" role="alert">
                    <h4>Hi <b class="newlySignedUpUser"></b> <a class="anchorjs-link"
