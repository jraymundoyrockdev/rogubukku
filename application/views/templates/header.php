 ...
 <!--   <li class="dropdown messages-dropdown">
    ...
    <li class="dropdown user-dropdown">
        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
            ...
            <span class="full_avatar_name"><?= Auth::instance()->get_user()->full_name ?></span> <b class="caret"></b></a>
            <ul class="dropdown-menu">
            <li><a href="<?= URL::site('user/profile'); ?>"><i class="fa fa-user-secret"></i> Profile</a></li>
            <li><a href="<?= URL::site('user/change_password'); ?>"><i class="fa fa-unlock-alt"></i> Change Password</a></li>
