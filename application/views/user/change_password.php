    ...
    <div class="col-lg-9">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <div id="password_updated_status" class="alert alert-success alert-dismissible fade in" role="alert" style="display:none;">
                ...
                <?=Form::open('user/change_password/save', array('class'=>'search_form','id'=>'change_password_form'));?>
                    ...
                    <div class="form-group">
                        <div class="confirm-new-password-error">
                            ...
                            <?=Form::password('confirm_new_password', '', ['placeholder'=>'Confirm New Password', 'class'=>'form-control']);?>
                        </div>
                    </div>
                    
                    <div class="form-group">
                        <?=Form::button('update_password', 'Update Password', array('type' => 'submit', 'class'=>'btn btn-primary btn-block'));?>
                    </div>
